...
def test_parse_transactions_fails(mock_memo_parser, caplog, mock_original_transaction):
	...
	with pytest.raises(ParserError):
		mock_memo_parser.parse_transactions(transactions=[mock_original_transaction], parser_class=MyParser)
...
def test_parse_transactions_success(mock_memo_parser, caplog, mock_original_transaction):
	...
	# Act
	r = mock_memo_parser.parse_transactions(transactions=[mock_original_transaction], parser_class=MyParser)
	assert len(r) == 1
